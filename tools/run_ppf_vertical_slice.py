...
def run(solver_executable: Path, output_dir: Path, fps: int = 24,
    ...
    report = {
        ...
        "solver_launch_id": diagnostics.solver_launch_id,
        ...
        "last_completed_logical_frame":
            diagnostics.last_completed_logical_frame,
        "last_fetched_frame": diagnostics.last_fetched_frame,
        "termination_requested": diagnostics.termination_requested,
        "last_valid_health_response":
            diagnostics.last_valid_health_response,
        ...
        "status_request_count": diagnostics.status_request_count,
        "status_success_count": diagnostics.status_success_count,
        "status_failure_count": diagnostics.status_failure_count,
        "status_latency_ms": diagnostics.status_latency_ms,
        "max_status_latency_ms": diagnostics.max_status_latency_ms,
