...
| Friction | `collision.surface_grip` | `surface_grip` | `friction` | artist value | 0 … 1 | `float32(value × 0.5)` | 0.5 UI → 0.25 PPF | yes |
...
|---|---|---|---|---|---|---|---|
| Friction | `collision.surface_grip` | `surface_grip` | `friction` | artist value | 0 … 1 | `float32(value × 0.5)` | 0.5 UI → 0.25 PPF |
